...
VARIANT_NAMES = {
    "SOC-V1": "Invoice & Vendor Phishing",
    "SOC-V2": "Deepfake Voice Executive Impersonation",
    "SOC-V3": "Smishing OTP Redirection",
    "LEGIT": "Normal Activity"
}

class SOCDetector:
    SIGNAL_NAMES = ["social_urgency_score", "voice_jitter_anomaly", "beneficiary_account_mismatch", "amount_deviation", "channel_risk", "device_risk"]
    ...
    def _evaluate_on_test_split(self, csv_path: str = None) -> Dict[str, Any]:
        ...
        self.benchmark_results = {
            ...
            "dataset": f"Social Engineering & Impersonation Dataset ({n_total:,} rows)",
